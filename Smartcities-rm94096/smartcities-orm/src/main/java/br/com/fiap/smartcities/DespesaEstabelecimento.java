...
public class DespesaEstabelecimento {
		...
		@Id
		@Column(name="cd_DespesaEstabelecimento")
		private int codigo;
		
		@Column(name="nm_Estabelecimento",nullable=false,length=50)
		private String nome;
		@CreationTimestamp
		@Column(name="dt_cadastroDespesa")
		...
		public DespesaEstabelecimento(int codigo, String nome, Calendar dataCadastro, Calendar dataModificacao) {
			super();
			this.codigo = codigo;
			this.nome = nome;
